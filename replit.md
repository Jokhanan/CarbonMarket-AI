...
**Core Engine Modules:**
- **Parameter Engine:** (`carbongpt/core/parameter_engine.py`) Manages parameters with validation, source tracking, dependency tracking, and auto-initialization from methodology defaults. Includes canonical fuel normalization and parameter status tracking.

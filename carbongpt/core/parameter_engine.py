...
PARAMETER_DEFINITIONS = {
    ...
    "ACM0002": [
        ...
        {"param_key": "EG_historical", "param_name": "Historical electricity generation", "category": "baseline", "unit": "MWh/yr", "data_type": "number", "min_value": 0, "max_value": 100000000, "is_ex_ante": True, "depends_on": [],
         ...
         "noise_terms": []},
        {"param_key": "plant_capacity_mw", "param_name": "Installed plant capacity", "category": "project", "unit": "MW", "data_type": "number", "min_value": 0, "max_value": 5000, "is_ex_ante": True, "depends_on": [],
         "aliases": ["installed capacity", "rated capacity", "nameplate capacity", "plant size MW"],
         "extraction_hint": "Extract the installed/rated capacity of the power plant in megawatts (MW)."},
        {"param_key": "capacity_factor", "param_name": "Capacity factor", "category": "project", "unit": "fraction", "data_type": "number", "default": 0.35, "min_value": 0.01, "max_value": 1.0, "is_ex_ante": True, "depends_on": [],
         "aliases": ["capacity factor", "load factor", "plant utilization"],
         "extraction_hint": "Extract the annual capacity factor as a fraction (e.g. 0.35 for 35%). Used to calculate annual generation from installed capacity."},
        {"param_key": "own_consumption_pct", "param_name": "Own consumption (auxiliary load)", "category": "project", "unit": "fraction", "data_type": "number", "default": 0.05, "min_value": 0.0, "max_value": 0.3, "is_ex_ante": True, "depends_on": [],
         "aliases": ["auxiliary consumption", "own use", "station use", "parasitic load"],
         "extraction_hint": "Extract the fraction of gross generation consumed internally by the plant (e.g. 0.05 for 5%)."},
    ...
    "AMS-I.D.": [
        ...
        {"param_key": "EF_grid", "param_name": "Grid emission factor", "category": "emission_factor", "unit": "tCO2/MWh", "data_type": "number", "min_value": 0.0, "max_value": 2.0, "is_ex_ante": True, "tool_reference": "TOOL07", "depends_on": [],
         ...
         "noise_terms": []},
        {"param_key": "plant_capacity_mw", "param_name": "Installed plant capacity", "category": "project", "unit": "MW", "data_type": "number", "min_value": 0, "max_value": 15, "is_ex_ante": True, "depends_on": [],
         "aliases": ["installed capacity", "rated capacity", "nameplate capacity", "plant size MW"],
         "extraction_hint": "Extract the installed/rated capacity of the small-scale power plant in MW. AMS-I.D. cap is 15 MW."},
        {"param_key": "capacity_factor", "param_name": "Capacity factor", "category": "project", "unit": "fraction", "data_type": "number", "default": 0.35, "min_value": 0.01, "max_value": 1.0, "is_ex_ante": True, "depends_on": [],
         "aliases": ["capacity factor", "load factor", "plant utilization"],
         "extraction_hint": "Extract the annual capacity factor as a fraction (e.g. 0.35 for 35%)."},
        {"param_key": "own_consumption_pct", "param_name": "Own consumption (auxiliary load)", "category": "project", "unit": "fraction", "data_type": "number", "default": 0.05, "min_value": 0.0, "max_value": 0.3, "is_ex_ante": True, "depends_on": [],
         "aliases": ["auxiliary consumption", "own use", "station use", "parasitic load"],
         "extraction_hint": "Extract the fraction of gross generation consumed internally (e.g. 0.05 for 5%)."},
    ],
